...
# operators.mytest.it/operator-textanalyzer-bundle:$VERSION and operators.mytest.it/operator-textanalyzer-catalog:$VERSION.
IMAGE_TAG_BASE ?= operators.mytest.it/operator-textanalyzer
